...
import Location4Container from "./Locations/Location4Container";
import Location1Container from "./Locations/Location1Container";
import Location2Container from "./Locations/Location2Container";
import Location3Container from "./Locations/Location3Container";
import Location5Container from "./Locations/Location5Container";
...
const ScaleLocation = () => {
  ...
  return (
    <div className="main-container">
      ...
      <div class="container">
      <h2 className="title">How satisfied were you with the location?</h2> 
            <div className="box">
            ...
            <div className="tags-additional">
              {
                (rating===1)?<div ><Location1Container></Location1Container></div>:null

              }
              {
                (rating===2)?<div><Location2Container></Location2Container></div>:null

              }
              {
                (rating===4)?<div><Location4Container></Location4Container></div>:null

              }
              {
                (rating===3)?<div><Location3Container></Location3Container></div>:null

              }
              {
                (rating===5)?<div><Location5Container></Location5Container></div>:null
